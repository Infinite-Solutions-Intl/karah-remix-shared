...
export type SubmissionStatusValue = 'DEGRADED' | 'IN_PROGRESS' | 'PARTIAL' | 'COMPLETED' | 'REJECTED' | 'VALIDATED' | 'CANCELLED';
/**
 ...
 */
export declare function requiresCompleteAnswers(status: SubmissionStatusValue): boolean;
/**
 ...
 */
export declare function countsTowardQuota(status: SubmissionStatusValue): boolean;
/**
 ...
 */
export declare function isTerminalStatus(status: SubmissionStatusValue): boolean;
/**
 ...
 */
export declare function requiresAnswerFormatChecks(): boolean;
