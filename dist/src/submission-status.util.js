...
exports.requiresCompleteAnswers = requiresCompleteAnswers;
exports.countsTowardQuota = countsTowardQuota;
exports.isTerminalStatus = isTerminalStatus;
exports.requiresAnswerFormatChecks = requiresAnswerFormatChecks;
/**
 ...
 */
function requiresCompleteAnswers(status) {
 ...
 */
function countsTowardQuota(status) {
 ...
 */
function requiresAnswerFormatChecks() {
    return true;
}
