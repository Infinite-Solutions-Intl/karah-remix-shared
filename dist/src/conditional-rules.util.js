...
exports.normalizeConditionalRules = normalizeConditionalRules;
exports.effectiveLogicalOperator = effectiveLogicalOperator;
/** Ramène `conditionalRules`, quelle que soit sa forme, à une liste de règles exploitables. */
function normalizeConditionalRules(raw) {
 ...
 */
function isUsableRule(candidate) {
 ...
 */
function effectiveLogicalOperator(rule) {
