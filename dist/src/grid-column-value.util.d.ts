 ...
 */
export declare function resolveColumnValue(column: GridColumnLike): string;
/**
 ...
 */
export declare function findDuplicateColumnValues(columns: GridColumnLike[]): string[];
/** Détecte les colonnes portant le même LIBELLÉ, sources de confusion à l'affichage. */
export declare function findDuplicateColumnLabels(columns: GridColumnLike[]): string[];
/**
 ...
 */
export declare function canSelectMore(currentSelection: unknown, maxPerRow: number | undefined | null): boolean;
