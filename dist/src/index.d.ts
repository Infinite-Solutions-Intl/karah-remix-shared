...
export { MAX_USABLE_ACCURACY_METERS, distanceInMeters, evaluatePosition, hasPosition, describeVerdict, } from './geofence.util';
export type { GpsFlag, SiteGeofence, GeofenceVerdict, Position as GeoPosition, } from './geofence.util';
